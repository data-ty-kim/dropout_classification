...
sns.swarmplot(data = df_final[df_final['REC_1'] == 1], x='covid_slope', ax=ax[0])
sns.swarmplot(data = df_final[df_final['REC_2'] == 1], x='covid_slope', ax=ax[1])
sns.swarmplot(data = df_final[df_final['REC_3'] == 1], x='covid_slope', ax=ax[2])
# plt.legend(['재학&휴학', '제적', '졸업&수료'])
plt.show()
